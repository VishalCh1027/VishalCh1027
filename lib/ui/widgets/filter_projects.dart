...
class FilterProjectsDailog extends StatefulWidget {
  FilterProjectsDailog({Key? key, this.orderItem});
  final OrderItem? orderItem;
  @override
  State<FilterProjectsDailog> createState() => _FilterProjectsDailog(orderItem);
}

class _FilterProjectsDailog extends State<FilterProjectsDailog> {
  _FilterProjectsDailog(this.orderItem);
